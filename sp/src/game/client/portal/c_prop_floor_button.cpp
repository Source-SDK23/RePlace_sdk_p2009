...
//--------------------------------------------------------------------------------------------------------
EXPOSE_INTERFACE(CLightedFloorButtonProxy, IMaterialProxy, "LightedFloorButton" IMATERIAL_PROXY_INTERFACE_VERSION);

//Original
//( CLightedFloorButtonProxy, LightedFloorButton );
