...
void CBasePanel::OnOpenKeyEntryDialog()
{
	if (!m_hKeyEntryDialog.Get())
	{
		m_hKeyEntryDialog = new CCDKeyEntryDialog(this);
		PositionDialog(m_hKeyEntryDialog);
	}
	m_hKeyEntryDialog->Activate();
}
